...
- (id) initWithFrame: (CGRect) frame
{
    ...
    if (self) {
        ...
        CGRect c = CGRectMake(w-137, h-137, 137, 137);
    ...
    if (touches.count > 0)
    {
        ...
        {// the above if statement is to ensure that you only move the piece of garvage when you grab within the bounds of it
            if(piece1.alpha!=0)
            {
                ...
                if((piece1.center.x+30 >= can.center.x-68.5 && piece1.center.x+30 <= can.center.x+68.5) && (piece1.center.y+28 >= can.center.y-68.5 && piece1.center.y+28<=can.center.y+68.5))
                {
        ...
        {// the above if statement is to ensure that you only move the piece of garbage when you grab within the bounds of it
            if(piece2.alpha!=0)
            {
                ...
                if((piece2.center.x+30 >= can.center.x-68.5 && piece2.center.x+30 <= can.center.x+68.5) && (piece2.center.y+28 >= can.center.y-68.5 && piece2.center.y+28<=can.center.y+68.5))
                {
        ...
        {// the above if statement is to ensure that you only move the piece of garbage when you grab within the bounds of it
            if(piece3.alpha!=0)
            {
                ...
                if((piece3.center.x+30 >= can.center.x-68.5 && piece3.center.x+30 <= can.center.x+68.5) && (piece3.center.y+28 >= can.center.y-68.5 && piece3.center.y+28<=can.center.y+68.5))
                {
